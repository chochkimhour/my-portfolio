            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    ...
                    <a href={PERSONAL_INFO.telegramUrl} target="_blank" rel="noopener noreferrer"
                        ...
                        <p className="text-gray-500 dark:text-gray-400 font-bold mb-4 tracking-tighter">{PERSONAL_INFO.telegramUsername}</p>
                    ...
                    <a href={`mailto:${PERSONAL_INFO.email}`}
                        ...
                        <p className="text-gray-500 dark:text-gray-400 font-bold mb-4 tracking-tighter">{UI_TEXT.contact.email_subtext}</p>
                        <span className="text-amber-600 dark:text-amber-400 font-black flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0">
                    ...
                    <a href={PERSONAL_INFO.linkedinUrl} target="_blank" rel="noopener noreferrer"
                        ...
                        <p className="text-gray-500 dark:text-gray-400 font-bold mb-4 tracking-tighter">{UI_TEXT.contact.linkedin_subtext}</p>
                        <span className="text-amber-600 dark:text-amber-400 font-black flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0">
