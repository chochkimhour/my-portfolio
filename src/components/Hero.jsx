            ...
            <div className="max-w-[1920px] mx-auto w-full px-6 sm:px-16 flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-12 relative z-10">
                ...
                <div className="flex-1 text-center lg:text-left space-y-6 sm:space-y-8 z-10 order-2 lg:order-1">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 sm:gap-6 pt-4">
                        ...
                        >
                            <span>{UI_TEXT.hero.github_button}</span>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-full sm:w-auto px-12 py-5 bg-white dark:bg-gray-900 text-gray-900 dark:text-white font-bold rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl shadow-gray-900/5 dark:shadow-black/20 hover:border-amber-500 hover:text-amber-600 dark:hover:text-amber-400 hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3 group"
                        >
                            <span>{UI_TEXT.hero.npm_button}</span>
