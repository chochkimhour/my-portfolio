                ...
                <div className="flex-1 text-center lg:text-left space-y-6 sm:space-y-8 z-10 order-2 lg:order-1">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-4 pt-4 w-full">
                        <a
                            ...
                            className="relative w-full sm:w-auto min-w-[210px] px-8 py-4 bg-gray-950 dark:bg-white text-white dark:text-gray-950 font-black rounded-2xl shadow-2xl shadow-gray-950/20 dark:shadow-white/10 hover:-translate-y-1 hover:shadow-amber-600/20 transition-all duration-300 flex items-center justify-center gap-3 group overflow-hidden"
                        >
                            <span className="absolute inset-0 bg-gradient-to-r from-amber-500/0 via-amber-500/20 to-amber-500/0 translate-x-[-120%] group-hover:translate-x-[120%] transition-transform duration-700"></span>
                            <span className="relative flex w-9 h-9 items-center justify-center rounded-xl bg-white/10 dark:bg-gray-950/10">
                            ...
                            <span className="relative flex flex-col items-start leading-none">
                                <span className="text-[10px] uppercase tracking-[0.22em] opacity-60 mb-1">Explore</span>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="relative w-full sm:w-auto min-w-[230px] px-8 py-4 bg-white dark:bg-gray-900 text-gray-950 dark:text-white font-black rounded-2xl border border-red-500/20 dark:border-red-400/20 shadow-2xl shadow-red-600/10 hover:-translate-y-1 hover:border-red-500/50 hover:shadow-red-600/20 transition-all duration-300 flex items-center justify-center gap-3 group overflow-hidden"
                        >
                            <span className="absolute inset-y-0 left-0 w-1.5 bg-red-600"></span>
                            <span className="absolute inset-0 bg-red-600/[0.04] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                            <span className="relative flex w-9 h-9 items-center justify-center rounded-xl bg-red-600 text-white shadow-lg shadow-red-600/20">
                            ...
                            <span className="relative flex flex-col items-start leading-none">
                                <span className="text-[10px] uppercase tracking-[0.22em] text-red-600 dark:text-red-400 mb-1">Package</span>
